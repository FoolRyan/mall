  ...
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath}/ProductServlet?op=findPageProduct&num=1" target="rightFrame">查看/修改商品</a></li>
    ...
    <li> <a class="head">分类管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/CategoryServlet?op=findPageCategory&num=1" target="rightFrame">查看/删除分类</a></li>
      </ul>
    </li>
    <li> <a class="head">订单管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath }/OrderServlet?op=findPageOrder&num=1" target="rightFrame">查询/修改订单</a></li>
      </ul>
    </li>
    <li> <a class="head">系统用户管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath }/admin/admin/addAdmin.jsp" target="rightFrame">添加系统用户</a></li>
        <li><a href="${pageContext.request.contextPath }/AdminServlet?op=findPageAdmin&num=1" target="rightFrame">查看/修改系统用户</a></li>
      </ul>
    </li>
    <li> <a class="head">注册用户管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath }/admin/user/addUser.jsp" target="rightFrame">添加普通用户</a></li>
        <li><a href="${pageContext.request.contextPath }/UserServlet?op=findPageUser&num=1" target="rightFrame">查看普通注册用户</a></li>
      </ul>
    </li>
