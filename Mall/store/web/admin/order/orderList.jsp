...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="0"
					...
					<c:forEach items="${pageHelper.list }" var="order">
						<tr>
							...
							<td height="8" bgcolor="#FFFFFF" class="STYLE19">
								<div align="center">${order.recipient}</div>
							</td>
							...
							<td height="10" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/OrderServlet?op=deleteOrder&oid=${order.oid}">删除</a> |
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/OrderServlet?op=findPageOrder&num=" + num;
