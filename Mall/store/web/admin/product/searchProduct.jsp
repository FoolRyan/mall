			...
			<tr>
			 ...
			 <tr class="STYLE10" >
				 <td height="22" align="center" bgColor="#a8c7ce">
					 商品编号：</td>
				 <td class="ta_01" bgcolor="#a8c7ce"><input type="text" name="pid" size="15" value="" id="Form1_userName" /></td>
				 <td height="22" align="center" bgcolor="#a8c7ce">
					 品牌：</td>
				 <td bgcolor="#a8c7ce">
			 ...
			 <tr class="STYLE10">
				 <td height="22" align="center" bgcolor="#a8c7ce">商品名称：</td>
				 <td bgcolor="#a8c7ce"><input type="text" name="pname" size="15" value="" id="Form1_userName" class="bg" /></td>
				 <td height="22" align="center" bgcolor="#a8c7ce">价格区间(元)：</td>
				 <td bgcolor="#a8c7ce">
