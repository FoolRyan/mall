    ...
    <div id="templatemo_main">
                    	...
                    	<c:forEach items="${categories }" var="category" varStatus="vs">
                			<c:if test="${vs.index !=0}">
                				<c:if test="${vs.index != fn:length(categories)-1 }">
                					<li>
                						<a href="${pageContext.request.contextPath }/frontEndProductServlet?op=byCid&cid=${category.cid}">${category.cname}</a>
                					</li>
                				</c:if>
                			</c:if>
                			<c:if test="${vs.index==0 }">
        ...
        <div id="content" class="float_r">
			...
			<!-- 
				 ...
				 birthday
			 -->
			<form action="${pageContext.request.contextPath }/frontEndUserServlet?op=updateUserInfo" method="post">
