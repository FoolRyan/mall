	...
	<table border="1" width="700" style="border-style: inherit; border-color: black;">
		...
		<c:forEach items="${orders}" var="order"  varStatus ="status">
			<tr style="color: grey">
				...
				<td>
					<c:if test="${order.state==1}"><a href="${pageContext.request.contextPath}/frontEndOrderServlet?op=cancelOrder&oid=${order.oid}&state=0">取消订单</a>
				   </c:if>
				</td>
			</tr>			
		</c:forEach>
